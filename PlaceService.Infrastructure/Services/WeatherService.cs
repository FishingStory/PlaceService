...
public class WeatherService(IWeatherForLocationService weatherForLocationService, ILocationMapper locationMapper)
    : IWeatherService
{
    ...
    public async Task<List<ResponseLocationDto>> GetWeatherForMultipleLocations(
        List<ResponseLocationDto> listLocationDto)
    {
